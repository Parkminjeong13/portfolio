export const skill = [
    ...
    },   
    {
        ...
        "desc": "각각의 컴포넌트에 대해 스타일을 정의하여 모듈화하고 재사용성을 높일 수 있습니다. 상태에 따라 다른 스타일을 적용할 수 있어 동적인 UI를 구현할 수 있습니다. 테마 변수를 활용하여 일관된 디자인 시스템을 적용할 수 있습니다"
    },
    {
        "img": "./images/icons/nextjs.svg",
        "title": "nextjs",
        "desc": "동적 경로를 통해 사용자가 요청한 데이터에 따라 다른 페이지를 렌더링할 수 있습니다."
    },
    {
    ...
    },    
    {
        ...
        "title": "nodejs",
        "desc": "HTTP 요청에 대한 응답을 처리하고, 웹 페이지를 동적으로 생성할 수 있습니다. RESTful API를 개발하여 클라이언트와 서버 간의 데이터 통신을 구현할 수 있습니다."
    },    
    {
